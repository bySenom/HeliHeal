...
function HeliHeal:BuildProcsPage(parent)
    ...
    local hint = text(page, "ADD PROC automatically assigns matching Blizzard buffs to Tracked Buff Bars (out of combat).\nEnable Hide When Inactive. TRACK retries existing entries. UNKNOWN means no reliable observation.", 11, C.muted)
