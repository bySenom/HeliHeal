...
local enUS = {
    ...
    ["Eine lokal bekannte Infusion priorisiert Flash of Light in Heilmodi und Judgment beziehungsweise Hammer of Wrath im Mana-Sparmodus. Hand of Divinity macht nach Wings die nächsten zwei Holy Lights sofort wirkbar und günstiger; HeliHeal stellt diese Holy Lights deshalb an die erste Stelle."] = "A locally known Infusion prioritizes Flash of Light in healing modes and Judgment or Hammer of Wrath in Mana Saving. After Wings, Hand of Divinity makes the next two Holy Lights instant and cheaper, so HeliHeal places those Holy Lights first.",
