...
local enUS = {
    ...
    ["DEF zeigt nur, welche defensiven und unterstützenden Fähigkeiten lokal bereit sind. Es bedeutet nicht, dass du sie sofort casten sollst. Nutze Divine Protection, Blessing of Sacrifice, Lay on Hands und ähnliche Werkzeuge passend zur Mechanik und zum Ziel."] = "DEF only shows which defensive and utility abilities are locally ready. It does not mean you should cast them immediately. Use Divine Protection, Blessing of Sacrifice, Lay on Hands, and similar tools for the appropriate mechanic and target.",
    ["BEACON"] = "BEACON",
    ["RAID / M+"] = "RAID / M+",
    ["MANA"] = "MANA",
