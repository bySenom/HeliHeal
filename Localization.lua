...
local enUS = {
    ...
    ["Übersicht"] = "Overview",
    ["FAQ & Spielhilfe"] = "FAQ & Play Guide",
    ["Kurze Antworten zur Anzeige und zur Spielweise deiner Spezialisierung."] = "Quick answers about the display and how to play your specialization.",
    ["FAQ & GUIDE"] = "FAQ & GUIDE",
    ["Spielweise & Ziele"] = "Playstyle & targets",
    ["Rotations-Snapshots"] = "Rotation Snapshots",
    ["Verdächtige festhängende Zustände lokal speichern, prüfen und kopieren."] = "Save, inspect, and copy suspected stuck states locally.",
    ["Automatisch nach 3 Blizzard-Fehlschlägen oder 6 gleichen Primär-Inputs und 3 Sekunden ohne Bestätigung. Keine Health-, Target- oder Aura-Daten."] = "Automatic after 3 Blizzard failures or 6 identical primary inputs and 3 seconds without confirmation. No health, target, or aura data.",
    ["JETZT AUFNEHMEN"] = "CAPTURE NOW",
    ["ALLE LÖSCHEN"] = "DELETE ALL",
    ["GESPEICHERTE FEHLER"] = "SAVED ISSUES",
    ["SNAPSHOT AUSWÄHLEN"] = "SELECT SNAPSHOT",
    ["In den Bericht klicken, dann Strg+A und Strg+C drücken."] = "Click the report, then press Ctrl+A and Ctrl+C.",
    ["Noch keine Snapshots gespeichert."] = "No snapshots saved yet.",
    ["Unbekannte Zeit"] = "Unknown time",
    ["KEIN SNAPSHOT"] = "NO SNAPSHOT",
    ["Unbekannte Fähigkeit"] = "Unknown ability",
    ["SNAPSHOTS"] = "SNAPSHOTS",
    ["Rotations-Diagnose"] = "Rotation diagnostics",
    ["Rotations-Snapshot gespeichert: %s"] = "Rotation snapshot saved: %s",
    ["%d THEMEN • SPELL-GUIDE"] = "%d TOPICS • SPELL GUIDE",
    ["ALLE ÖFFNEN"] = "EXPAND ALL",
    ["ALLE SCHLIESSEN"] = "COLLAPSE ALL",
    ["ALLGEMEIN"] = "GENERAL",
    ["SYSTEM"] = "SYSTEM",
    ["ANZEIGE"] = "DISPLAY",
    ["PRIORITÄT"] = "PRIORITY",
    ["MODI"] = "MODES",
    ["SPELL-GUIDE"] = "SPELL GUIDE",
    ["GRUNDLAGEN"] = "BASICS",
    ["ZIELWAHL"] = "TARGETING",
    ["MECHANIK"] = "MECHANIC",
    ["PROC"] = "PROC",
    ["DEFENSIV"] = "DEFENSIVE",
    ["ZUGEHÖRIGE ZAUBER"] = "RELATED SPELLS",
    ["Was entscheidet HeliHeal wirklich?"] = "What does HeliHeal actually decide?",
    ["HeliHeal ordnet eine feste Guide-Priorität anhand bestätigter eigener Zauber und lokal berechneter Zustände. Es sieht keine Gesundheit, Ziele, Reichweite, Auren oder eingehenden Schaden. Die erste Empfehlung ist daher eine Priorität, kein automatischer Heilbefehl."] = "HeliHeal orders a fixed guide priority using confirmed player casts and locally calculated states. It cannot see health, targets, range, auras, or incoming damage. The first recommendation is therefore a priority, not an automatic healing command.",
    ["Wie lese ich die fünf Empfehlungen?"] = "How do I read the five recommendations?",
    ["Das große erste Icon ist die aktuell höchste lokale Priorität. Die kleineren Icons zeigen sinnvolle Folgeschritte. Ein entsättigtes Icon mit Timer ist noch nicht bereit; ein entsättigter Paladin-Spender mit 3 HP ist nur ein späterer Schritt und darf erst mit genügend Holy Power benutzt werden."] = "The large first icon is the current highest local priority. The smaller icons show useful follow-up steps. A desaturated icon with a timer is not ready yet; a desaturated Paladin spender marked 3 HP is only a future step and requires enough Holy Power.",
    ["Wann sollte ich von der Empfehlung abweichen?"] = "When should I ignore the recommendation?",
    ["Immer wenn die Spielsituation es verlangt: Dispel, Bewegung, Mechaniken, ein sterbender Spieler oder ein geplanter defensiver Cooldown sind wichtiger. HeliHeal ersetzt keine Zielwahl und keine Begegnungskenntnis."] = "Whenever the situation demands it: dispels, movement, mechanics, a dying player, or a planned defensive cooldown take priority. HeliHeal does not replace target selection or encounter knowledge.",
    ["Welchen Rotationsmodus sollte ich wählen?"] = "Which rotation mode should I choose?",
    ["Standard ist der vielseitige Ausgangspunkt. AoE hebt Gruppenheilung an, Single Target priorisiert gezielte Heilung und Mana Saving verschiebt teure oder weniger effiziente Zauber nach hinten. Der Modus kennt die echte Gesundheit deiner Gruppe nicht; wechsle ihn deshalb passend zur erwarteten Schadensart und zu deinem Mana-Plan."] = "Standard is the versatile starting point. AoE raises group healing, Single Target prioritizes focused healing, and Mana Saving moves expensive or less efficient spells back. The mode cannot see your group's actual health, so switch it to match the expected damage pattern and your mana plan.",
    ["Was zeigen die Spell-Icons im Guide?"] = "What do the spell icons in the guide show?",
    ["Die Icons unter einer geöffneten Antwort zeigen die Zauber, auf die sich der Text bezieht. Fahre mit der Maus darüber, um Blizzards vollständigen Spell-Tooltip mit deiner aktuellen Talentversion zu sehen. Die Icons sind Erklärhilfen und keine zusätzliche Empfehlungsliste."] = "The icons below an expanded answer show the spells discussed by the text. Hover over one to see Blizzard's full spell tooltip for your current talent version. These icons are explanatory aids, not another recommendation list.",
    ["%s • %d THEMEN"] = "%s • %d TOPICS",
    ["ANTWORT ÖFFNEN"] = "EXPAND ANSWER",
    ["Wie funktioniert die Holy-Paladin-Grundrotation?"] = "How does the basic Holy Paladin rotation work?",
    ["Erzeuge Holy Power, ohne bei 5 weiter zu überfüllen, und gib sie mit Word of Glory oder Eternal Flame aus. Light of Dawn ist im HeliHeal-Modell nur für Raid vorgesehen. Holy Shock bleibt ein zentraler Generator; große Cooldowns solltest du für echte Schadensfenster planen."] = "Generate Holy Power without overcapping at 5, then spend it with Word of Glory or Eternal Flame. HeliHeal uses Light of Dawn only in Raid. Holy Shock remains a core generator; plan major cooldowns for real damage windows.",
    ["Auf wen caste ich Holy Bulwark?"] = "Who should receive Holy Bulwark?",
    ["Mit Solidarity ist der Self-Cast die starke Standardlösung: Der zusätzliche Holy Bulwark springt auf einen Tank und skaliert mit dessen hoher maximaler Gesundheit. Caste direkt auf einen verwundbaren oder besonders gefährdeten Verbündeten, wenn du das Ziel bewusst kontrollieren musst. Seit 12.1 verlängert ein erneuter Cast desselben Casters die laufende Armament-Dauer; HeliHeal bildet diese Verlängerung lokal nach."] = "With Solidarity, self-cast is the strong default: the additional Holy Bulwark jumps to a tank and scales with that tank's high maximum health. Cast directly on a vulnerable or particularly endangered ally when you need deliberate target control. Since 12.1, another cast from the same caster extends the active Armament duration; HeliHeal reproduces that extension locally.",
    ["Auf wen caste ich Sacred Weapon?"] = "Who should receive Sacred Weapon?",
    ["Caste Sacred Weapon normalerweise auf dich selbst. Mit Solidarity erhält zusätzlich ein anderer Heiler oder in Mythic+ ein DPS-Spieler die Waffe; ihr Heilungs- oder Schadenswert hängt nicht davon ab, welchen DPS oder Heiler sie trifft. Nutze einen direkten Fremd-Cast nur bewusst, etwa für die Verbindung von Tempered in Battle."] = "Normally cast Sacred Weapon on yourself. With Solidarity, another healer or, in Mythic+, a damage dealer also receives the weapon; its healing or damage value does not depend on which damage dealer or healer receives it. Use a direct cast on someone else deliberately, such as for the Tempered in Battle link.",
    ["Warum wechseln Holy Bulwark und Sacred Weapon?"] = "Why do Holy Bulwark and Sacred Weapon alternate?",
    ["Holy Armaments ist eine einzige Fähigkeit mit zwei gemeinsamen Charges. Jeder bestätigte Cast wechselt zur anderen Variante: Holy Bulwark wird Sacred Weapon und danach wieder Holy Bulwark. Beide benutzen in HeliHeal denselben Hotkey."] = "Holy Armaments is one ability with two shared charges. Every confirmed cast switches to the other variant: Holy Bulwark becomes Sacred Weapon and then Holy Bulwark again. Both use the same HeliHeal hotkey.",
    ["Was mache ich mit Infusion of Light und Hand of Divinity?"] = "How should I use Infusion of Light and Hand of Divinity?",
    ["Eine lokal bekannte Infusion priorisiert Flash of Light in Heilmodi und Judgment beziehungsweise Hammer of Wrath im Mana-Sparmodus. Hand of Divinity macht nach Wings die nächsten zwei Holy Lights sofort wirkbar und günstiger. Mit dem 12.1-Viererset schiebt HeliHeal den garantierten Infusion-Verbrauch zwischen diese beiden Holy Lights, damit der zweite Proc nicht überschrieben wird."] = "A locally known Infusion prioritizes Flash of Light in healing modes and Judgment or Hammer of Wrath in Mana Saving. After Wings, Hand of Divinity makes the next two Holy Lights instant and cheaper. With the 12.1 four-piece bonus, HeliHeal inserts the guaranteed Infusion consumer between those Holy Lights so the second proc is not overwritten.",
    ["Was bedeutet das separate DEF-Fenster?"] = "What does the separate DEF window mean?",
    ["DEF zeigt nur, welche defensiven und unterstützenden Fähigkeiten lokal bereit sind. Es bedeutet nicht, dass du sie sofort casten sollst. Nutze Divine Protection, Blessing of Sacrifice, Lay on Hands und ähnliche Werkzeuge passend zur Mechanik und zum Ziel. Uther's Counsel reduziert Divine Shield, Blessing of Protection und Lay on Hands um 15 Prozent; HeliHeal kombiniert dies lokal mit weiteren ausgewählten Cooldown-Talenten."] = "DEF only shows which defensive and utility abilities are locally ready. It does not mean you should cast them immediately. Use Divine Protection, Blessing of Sacrifice, Lay on Hands, and similar tools for the appropriate mechanic and target. Uther's Counsel reduces Divine Shield, Blessing of Protection, and Lay on Hands by 15 percent; HeliHeal combines it locally with other selected cooldown talents.",
    ["BEACON"] = "BEACON",
    ["RAID / M+"] = "RAID / M+",
    ["MANA"] = "MANA",
    ["DISPEL / UTILITY"] = "DISPEL / UTILITY",
    ["BEWEGUNG"] = "MOVEMENT",
    ["Wie wähle ich Beacon-Ziele richtig?"] = "How should I choose Beacon targets?",
    ["Beacon of Light oder Faith liegt häufig gut auf entfernten Spielern, weil das Ziel zusätzlich als Zentrum für Mastery: Lightbringer dient. Heile ein Beacon-Ziel nur direkt, wenn es die Heilung wirklich braucht, da normale Beacon-Übertragung von Heilung an anderen Zielen entsteht. Beacon of Virtue kommt auf einen verletzten Verbündeten, nicht auf dich selbst; plane die folgenden starken Heilzauber in sein kurzes Fenster."] = "Beacon of Light or Faith is often well placed on ranged players because the target also acts as a center for Mastery: Lightbringer. Only heal a Beacon target directly when it truly needs the healing, since normal Beacon transfer comes from healing other targets. Cast Beacon of Virtue on an injured ally, not yourself, and plan the following powerful heals inside its short window.",
    ["Wie unterscheiden sich Raid und Mythic+?"] = "How do Raid and Mythic+ differ?",
    ["Im Raid ist Beacon of Virtue ein wichtiges Burst-Fenster: Ringing of the Heavens und Divine Toll gewinnen viel Wert, wenn Virtue bereits aktiv ist. In Mythic+ kann diese vollständige Kombination unnötig viel auf einmal sein; trenne Virtue und große Cooldowns, um mehrere Schadenswellen abzudecken. Light of Dawn bleibt in HeliHeal eine Raid-Option, während Mythic+ den Einzelziel-Spender nutzt."] = "In Raid, Beacon of Virtue is an important burst window: Ringing of the Heavens and Divine Toll gain substantial value while Virtue is already active. In Mythic+, combining everything can be unnecessary overkill; separate Virtue and major cooldowns to cover multiple damage waves. HeliHeal keeps Light of Dawn as a Raid option while Mythic+ uses the single-target spender.",
    ["Wie spare ich Mana als Holy Paladin?"] = "How do I conserve mana as a Holy Paladin?",
    ["Holy Light ist dein größter regelbarer Mana-Hebel: caste es häufiger für hohen Durchsatz und seltener, wenn du zu schnell Mana verlierst. Wenn gerade keine Heilung nötig ist, gibt Shield of the Righteous bei einem Treffer Mana zurück; ein offensiver Holy Shock kann mit Light's Conviction ebenfalls günstiger sein. Das sind bewusste Heilungsverluste und gehören deshalb in den Mana-Saving-Kontext, nicht in ein akutes Heilfenster."] = "Holy Light is your largest controllable mana lever: cast it more often for high throughput and less often when you are spending mana too quickly. When no healing is needed, Shield of the Righteous returns mana if it hits, and an offensive Holy Shock can also be cheaper with Light's Conviction. These are deliberate healing losses and therefore belong in the Mana Saving context, not an urgent healing window.",
    ["Warum empfiehlt HeliHeal keinen Dispel automatisch?"] = "Why doesn't HeliHeal recommend dispels automatically?",
    ["Midnight erlaubt HeliHeal nicht, einen Debuff zuverlässig auszuwerten und daraus eine eigene Kampfentscheidung zu berechnen. Nutze die Blizzard-Raidframes für Cleanse. Blessing of Protection entfernt oder verhindert physische Effekte, nimmt dem Ziel aber Aggro — deshalb nicht ohne Absprache auf den Tank. Blessing of Sacrifice ist dein häufiges externes Defensive; achte dabei selbst auf den übertragenen Schaden."] = "Midnight does not allow HeliHeal to reliably evaluate a debuff and calculate its own combat decision from it. Use Blizzard raid frames for Cleanse. Blessing of Protection removes or prevents physical effects but drops the target's threat, so do not use it on the tank without coordination. Blessing of Sacrifice is your frequent external defensive; watch the transferred damage on yourself.",
    ["Was mache ich während Bewegung?"] = "What should I do while moving?",
    ["HeliHeal kann nicht zuverlässig erkennen, ob du gerade laufen musst. Nutze während Bewegung verfügbare Instant-Zauber wie Holy Shock und Holy-Power-Spender und verschiebe einen normalen Holy-Light-Cast. Ein durch Hand of Divinity vorbereiteter Holy Light ist instant und bleibt deshalb auch in Bewegung nutzbar. Divine Steed gehört zur Positionierung, nicht automatisch zur Heilpriorität."] = "HeliHeal cannot reliably determine whether you need to move. While moving, use available instant spells such as Holy Shock and Holy Power spenders and delay a normal Holy Light cast. A Holy Light prepared by Hand of Divinity is instant and therefore remains usable while moving. Divine Steed is a positioning tool, not an automatic healing priority.",
    ...
    ["EINZELZIEL"] = "SINGLE TARGET",
    ["MANA SPAREN"] = "MANA SAVING",
    ["Talent-Build %s"] = "Talent Build %s",
    ["Talent-Build-Verknüpfung"] = "Talent Build Link",
    ["Automatische Rotationszuordnung"] = "Automatic Rotation Assignment",
    ["Weise gespeicherte Blizzard-Talent-Builds direkt einem Preset und Modus zu."] = "Assign saved Blizzard talent builds directly to a preset and mode.",
    ["AKTIV"] = "ACTIVE",
    ["TALENT-BUILD"] = "TALENT BUILD",
    ["ROTATION"] = "ROTATION",
    ["MODUS"] = "MODE",
    ["KEINE TALENT-BUILDS"] = "NO TALENT BUILDS",
    ["Talent-Build-Zuordnung konnte nicht gespeichert werden."] = "The talent build assignment could not be saved.",
    ["Verknüpft den aktiven Blizzard-Talent-Build mit dem gewählten Preset und Modus."] = "Links the active Blizzard talent build to the selected preset and mode.",
    ["Aktiver Build: %s (Config %s)"] = "Active build: %s (Config %s)",
    ["Verknüpft mit %s • %s"] = "Linked to %s • %s",
    ["Noch nicht verknüpft. Preset und Modus wählen, dann verknüpfen."] = "Not linked yet. Select a preset and mode, then link it.",
    ["VERKNÜPFEN"] = "LINK",
    ["ZUWEISEN"] = "ASSIGN",
    ["LÖSCHEN"] = "REMOVE",
    ["Aktiver Talent-Build ist noch nicht lesbar."] = "The active talent build is not readable yet.",
    ["Talent-Build %s wurde mit %s und %s verknüpft."] = "Talent build %s was linked to %s and %s.",
    ["Verknüpfung für Talent-Build %s entfernt."] = "Removed the link for talent build %s.",
    ["Automatischer Mana-Sparmodus"] = "Automatic Mana Saving Mode",
    ["Automatischer Mana-Sparmodus bei %.1f%% aktiviert."] = "Automatic Mana Saving Mode activated at %.1f%%.",
    ["Automatischer Mana-Sparmodus bei %.1f%% beendet."] = "Automatic Mana Saving Mode ended at %.1f%%.",
    ["Wechselt unter der gewählten lokalen Mana-Schwelle automatisch zu Mana sparen."] = "Automatically switches to Mana Saving below the selected local mana threshold.",
    ["Nutzt die gespeicherte lokale Mana-Schätzung; eine manuelle Kalibrierung ist nur optional."] = "Uses the persisted local mana estimate; manual calibration is optional.",
    ...
    ["Situationsauswahl"] = "Situational choice",
    ["Zeigt gleichwertige situative Fähigkeiten als ODER-Auswahl an."] = "Shows equivalent situational abilities as an OR choice.",
    ["ODER"] = "OR",
    ["Cooldown-Zahl"] = "Cooldown number",
    ["DEF / Utility-Fenster"] = "DEF / Utility window",
    ["Zeigt Paladin-Defensiv-, externe Schutz- und Bewegungsfähigkeiten als separate Bereitschaftsleiste."] = "Shows Paladin personal defensives, external protection and movement tools in a separate readiness strip.",
    ["Vertikal"] = "Vertical",
    ["DEF-Ausrichtung"] = "DEF orientation",
    ["Ordnet die DEF- und Utility-Fähigkeiten waagerecht oder senkrecht an."] = "Arranges the DEF and utility abilities horizontally or vertically.",
    ["DEF-Panel-Hintergrund"] = "DEF panel background",
    ["Zeigt einen eigenen Hintergrund um das DEF-Fenster."] = "Shows a separate background around the DEF window.",
    ["DEF-Header"] = "DEF header",
    ["Zeigt die Überschrift DEF / UTILITY in diesem Fenster."] = "Shows the DEF / UTILITY heading in this window.",
    ["DEF-Fähigkeitsnamen"] = "DEF ability names",
    ["Zeigt die Fähigkeitsnamen nur im DEF-Fenster."] = "Shows ability names only in the DEF window.",
    ["DEF-Icon-Rahmen"] = "DEF icon borders",
    ["Zeigt Rahmen und Schatten nur an den DEF-Icons."] = "Shows borders and shadows only on DEF icons.",
    ["DEF-Hotkeys"] = "DEF hotkeys",
    ["Zeigt die beobachteten Tasten nur im DEF-Fenster."] = "Shows observed key bindings only in the DEF window.",
    ["DEF-Cooldowns"] = "DEF cooldowns",
    ["Zeigt lokale Timer und Aufladungen nur im DEF-Fenster."] = "Shows local timers and charges only in the DEF window.",
    ["DEF-Fenster-Skalierung"] = "DEF window scale",
    ["Skaliert dieses Fenster unabhängig von der Hauptleiste."] = "Scales this window independently from the main strip.",
    ["DEF-Icon-Breite"] = "DEF icon width",
    ["Breite der Icons in diesem Fenster."] = "Width of the icons in this window.",
    ["DEF-Icon-Höhe"] = "DEF icon height",
    ["Höhe der Icons in diesem Fenster."] = "Height of the icons in this window.",
    ["DEF-Icon-Zoom"] = "DEF icon zoom",
    ["Zoomt die Textur nur in den DEF-Icons."] = "Zooms the texture only inside DEF icons.",
    ["DEF-Abstand"] = "DEF spacing",
    ["Abstand zwischen den DEF-Icons."] = "Spacing between DEF icons.",
    ["DEF-Icons X"] = "DEF icons X",
    ["Verschiebt die Icon-Gruppe innerhalb des DEF-Fensters horizontal."] = "Moves the icon group horizontally inside the DEF window.",
    ["DEF-Icons Y"] = "DEF icons Y",
    ["Verschiebt die Icon-Gruppe innerhalb des DEF-Fensters vertikal."] = "Moves the icon group vertically inside the DEF window.",
    ["DEF-Icon-Innenabstand"] = "DEF icon inset",
    ["Abstand zwischen DEF-Textur und Rahmen."] = "Space between the DEF texture and its border.",
    ["DEF-Panel-Innenabstand X"] = "DEF panel padding X",
    ["Horizontaler Innenraum des DEF-Fensters."] = "Horizontal padding inside the DEF window.",
    ["DEF-Panel-Innenabstand Y"] = "DEF panel padding Y",
    ["Vertikaler Innenraum des DEF-Fensters."] = "Vertical padding inside the DEF window.",
    ["DEF-Panel-Deckkraft"] = "DEF panel opacity",
    ["Deckkraft des eigenen DEF-Hintergrunds."] = "Opacity of the separate DEF background.",
    ["DEF / Utility-Skalierung"] = "DEF / Utility scale",
    ["Skaliert die separate Paladin-Bereitschaftsleiste zusätzlich zur allgemeinen HUD-Skalierung."] = "Scales the separate Paladin readiness strip in addition to the general HUD scale.",
    ...
    ["AKZENT"] = "ACCENT",
    ["FENSTER"] = "WINDOW",
    ["Optionsfenster-Hintergrund"] = "Options window background",
    ["Ändert die Grundfarbe dieses Einstellungsfensters."] = "Changes the base color of this settings window.",
    ["Optionsfenster-Akzent"] = "Options window accent",
    ["Farbe für aktive Schaltflächen, Linien und Markierungen im Optionsfenster."] = "Color used for active buttons, lines and highlights in the options window.",
    ["Klassenfarbe verwenden"] = "Use class color",
    ["Verwendet die aktuelle Spielerklasse als Akzentfarbe; die eigene Akzentfarbe bleibt gespeichert."] = "Uses the current player class as the accent color; the custom accent remains saved.",
    ...
    ["Alle Änderungen werden in diesem Profil gespeichert."] = "All changes are saved to this profile.",
    ["VORHANDENE PROFILE"] = "EXISTING PROFILES",
    ["NEUES PROFIL"] = "NEW PROFILE",
    ["Erstelle eine leere Konfiguration oder kopiere das aktuell aktive Profil."] = "Create an empty configuration or copy the currently active profile.",
    ...
    ["Löscht ein nicht aktives Profil dauerhaft."] = "Permanently deletes an inactive profile.",
    ["WARTUNG & RESET"] = "MAINTENANCE & RESET",
    ["Nur lokale Timer"] = "Local timers only",
    ["Alle Klassen-Hotkeys"] = "All class hotkeys",
    ["Aktives Profil"] = "Active profile",
    ["UI NEU LADEN"] = "RELOAD UI",
    ["Interface aktualisieren"] = "Refresh interface",
    ...
    ["CPU: Profiling aus • Speicher: %s"] = "CPU: profiling off • Memory: %s",
    ["CPU: %.2f%% • Speicher: %s"] = "CPU: %.2f%% • Memory: %s",
    ["CPU: misst… • Speicher: %s"] = "CPU: measuring… • Memory: %s",
    ...
    ["Favor: -10% Mana/-15% Cast"] = "Favor: -10% mana/-15% cast",
    ["Overload: +30% Heilung/+20% Mana"] = "Overload: +30% healing/+20% mana",
