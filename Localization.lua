...
local enUS = {
    ...
    ["Gib Holy Bulwark bevorzugt einem Tank, einem verwundbaren Verbündeten oder einem Spieler vor sicherem Schaden. Die einfache Standardlösung mit Solidarity ist ein Cast auf dich selbst: Du behältst den Schild und ein Verbündeter erhält ebenfalls ein Armament. Überschreibe möglichst keinen bereits aktiven Holy Bulwark."] = "Prefer Holy Bulwark on a tank, a vulnerable ally, or someone about to take predictable damage. With Solidarity, casting it on yourself is the simple default: you keep the shield and an ally also receives an Armament. Avoid overwriting an existing Holy Bulwark when possible.",
    ["Auf wen caste ich Sacred Weapon?"] = "Who should receive Sacred Weapon?",
    ["Für mehr Schaden eignet sich ein aktiver DPS-Spieler; für Heilwert ein Spieler mit hoher Zauberaktivität. Mit Solidarity ist Selbst-Cast erneut die einfache sichere Lösung, weil zusätzlich ein Verbündeter profitiert. Überschreibe möglichst keine bereits aktive Sacred Weapon."] = "For more damage, choose an active damage dealer; for healing value, choose a player casting frequently. With Solidarity, self-cast is again the simple safe default because an ally also benefits. Avoid overwriting an existing Sacred Weapon when possible.",
