...
local enUS = {
    ...
    ["Automatisch nach 6 gleichen Primär-Inputs und 3 Sekunden ohne Cast-Bestätigung. Keine Health-, Target- oder Aura-Daten."] = "Automatic after 6 identical primary inputs and 3 seconds without cast confirmation. No health, target, or aura data.",
