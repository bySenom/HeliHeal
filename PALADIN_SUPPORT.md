...
- Generic failed casts never subtract charges. Successful casts still apply their effects when the local estimate is empty, retaining a conservative zero post-cast count and any running recharge. Repeated readable cast GUIDs are ignored for 120 seconds across confirmation paths.
